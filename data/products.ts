...
export const products: Product[] = [
  ...
  },
  {
    ...
    category: "Papad",
    description: "A thin, crisp papad with cumin and pepper seasoning for everyday meals and snacks.",
    weight: ["500GM"],
  ...
  },
  {
    ...
    category: "Papad",
    description: "A crisp papad seasoned with garlic and mari spices.",
    weight: ["500GM"],
  ...
  },
  {
    ...
    name: "Puri Papad",
    category: "Papad",
    description: "Classic Aaswad papad with a light, crisp texture and traditional seasoning.",
    weight: ["500GM"],
  ...
  },
  {
    ...
    description: "7-inch khichiya papad with green chilli seasoning and a crisp snack texture.",
    weight: ["500GM"],
  ...
  },
  {
    ...
    category: "Rice Papad",
    description: "5-inch red chilli rice papad with a spicy, crisp texture.",
    weight: ["250GM", "500GM"],
  ...
  },
  {
    ...
    category: "Rice Papad",
    description: "3-inch rice papad with jeera seasoning and a crisp, compact shape.",
    weight: ["500GM"],
  ...
  },
  {
    ...
    category: "Coin Papad",
    description: "Small, crisp coin papads with a fresh green chilli flavour.",
    weight: ["500GM"],
  ...
  },
  {
    ...
    category: "Coin Papad",
    description: "Small, crisp coin papads seasoned with aromatic cumin.",
    weight: ["500GM"],
  ...
  },
  {
    ...
    category: "Coin Papad",
    description: "Small, crisp coin papads with a lively red chilli flavour.",
    weight: ["500GM"],
  ...
  },
  {
    ...
    category: "Coin Papad",
    description: "Small, crisp coin papads with the warm flavour of ajwain.",
    weight: ["500GM"],
